<div>
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="bg-gray-50 dark:bg-zinc-700 px-4 py-3 rounded-lg">
            ...
            <!-- Upload New Picture -->
            <div>
                <label for="new_profile_picture" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Upload New Picture
                </label>
                <input type="file" 
                ...
                @if($new_profile_picture)
                    <div class="mt-2">
                        ...
                        @if($new_profile_picture->isPreviewable())
                            <img src="{{ $new_profile_picture->temporaryUrl() }}" 
                                 alt="Preview" 
                                 class="w-24 h-24 rounded-full object-cover border-2 border-gray-200 dark:border-gray-600">
                        @else
                            <p class="text-sm text-gray-500">File selected: {{ $new_profile_picture->getClientOriginalName() }}</p>
                        @endif
                    </div>
                @endif
            </div>
        ...
        <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-600">
            ...
            <button type="submit" 
                ...
                <span wire:loading.remove wire:target="save">Update Member</span>
